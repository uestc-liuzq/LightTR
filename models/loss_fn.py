...
def check_rn_dis_loss(predict_gps, predict_id, predict_rate, target_gps, target_id, target_rate, trg_len,rn
                      ):
    """
    ...
    for bs in range(batch_size):
        for len_i in range(trg_len[bs]-1): # don't calculate padding points
            ...
            pre_candi_pt = CandidatePoint(predict_gps[bs,len_i][0], predict_gps[bs,len_i][1],0, 0, 0, pre_rate)
